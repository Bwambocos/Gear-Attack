...
void Ranking::draw() const
{
	...
	for (auto i : step(rankingData.size())) rankFont(Format(i + 1) + U"位 " + rankingData[i].second + U" " + Format(rankingData[i].first) + U"点").draw(15, choice1Rect.y + choice1Rect.h + 10 + rankFont.height()*i);
}
